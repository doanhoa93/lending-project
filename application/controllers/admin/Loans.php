...
class Loans extends Admin_Controller {
    ...
    public function __construct()
    {
        ...
        /* Load :: Common */
        $this->lang->load('admin/loans');

        /* Title Page :: Common */
        $this->page_title->push(lang('menu_loans'));
        $this->data['pagetitle'] = $this->page_title->show();

        /* Breadcrumbs :: Common */
        $this->breadcrumbs->unshift(1, lang('menu_loans'), 'admin/loans');
    }
	...
	public function index()
	{
        ...
        else
        {
            ...
            /* Load Template */
            $this->template->admin_render('admin/lends/index', $this->data);
        }
	}
	...
	public function create()
	{
        ...
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
        $this->template->admin_render('admin/lends/create', $this->data);
	}
	...
	{
        /* Load Template */
		$this->template->admin_render('admin/lends/delete', $this->data);
	}
