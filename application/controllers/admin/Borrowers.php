...
class Borrowers extends Admin_Controller {
    ...
    public function edit($id)
    {
        ...
        if (isset($_POST) && ! empty($_POST))
        {
            ...
            if ($this->form_validation->run() == TRUE)
            {
                ...
                if($this->ion_auth->update($user->id, $data))
                {
                    ...
                    if ($this->ion_auth->is_admin())
                    {
                        redirect('admin/borrowers', 'refresh');
                    }
                    else
                    {
        ...
        $this->data['message'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message',message_box('Update borrower success','success'))));
        ...
        /* Load Template */
        $this->template->admin_render('admin/borrowers/edit', $this->data);
    }

    public function delete($id = null){
         if(!empty($id)){
         	$this->user_model->delete($id);
         	$this->session->set_flashdata('message',message_box('Borrowers has been deleted','success'));
