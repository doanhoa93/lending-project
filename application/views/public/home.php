...
<body>
    <section class="slider-area">
        <div class="slider-active2 slider-next-prev-style">
            <div class="slider-items">
                <img src="<?php echo base_url($frameworks_dir . '/assets/images/slider/4.jpg'); ?>" alt="" class="slider">
            ...
            <div class="slider-items">
                <img src="<?php echo base_url($frameworks_dir . '/assets/images/slider/3.jpg'); ?>" alt="" class="slider">
                <div class="slider-content text-center">
                    <div class="table">
                        <div class="table-cell">
                            <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-xs-12 wow fadeInLeft">
                    <div class="about-img black-opacity">
                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/about.jpg'); ?>" alt="" />
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".1s">
                    <div class="service-wrap">
                        <div class="service-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/service/1.jpg'); ?>" alt="" />
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".2s">
                    <div class="service-wrap">
                        <div class="service-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/service/2.jpg'); ?>" alt="" />
                        </div>
                        <div class="service-content">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".3s">
                    <div class="service-wrap">
                        <div class="service-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/service/3.jpg'); ?>" alt="" />
                        </div>
                        <div class="service-content">
                            <h3>Creative Arts</h3>
                            <p>majority have suffered alteration in some form, by injected humour, or randomised. by injected humour, or randomised.</p>
    ...
    <!-- fanfact-area start -->
    <section class="fanfact-area parallax black-opacity"  data-speed="5" data-bg-image="<?php echo base_url($frameworks_dir . '/assets/images/bg/1.jpg'); ?>">
        <div class="table">
            <div class="table-cell">
                <div class="container">
                    <div class="row">
            ...
            <div class="row grid">
                <div class="col-md-4 portfolio clean col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".1s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/1.jpg'); ?>">
                        ...
                        <div class="portfolio-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/1.jpg'); ?>" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4 portfolio website col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".2s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/2.jpg'); ?>">
                                <i class="fa fa-link"></i>
                            </a>
                            <h3>Web Development</h3>
                            <p>The majority have suffered alteration in some form</p>
                        ...
                        <div class="portfolio-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/2.jpg'); ?>" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4 portfolio minimal col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".3s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/3.jpg'); ?>">
                                <i class="fa fa-link"></i>
                            </a>
                            <h3>UX/UI Design</h3>
                            <p>The majority have suffered alteration in some form</p>
                        ...
                        <div class="portfolio-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/3.jpg'); ?>" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4 portfolio website col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".4s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/4.jpg'); ?>">
                                <i class="fa fa-link"></i>
                            </a>
                        ...
                        <div class="portfolio-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/4.jpg'); ?>" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4 portfolio  responsiv col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".5s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/5.jpg'); ?>">
                                <i class="fa fa-link"></i>
                            </a>
                        ...
                        <div class="portfolio-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/6.jpg'); ?>" alt="" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4 portfolio minimal col-sm-6 col-xs-12 col wow fadeInUp"  data-wow-delay=".6s">
                    <div class="portfolio-wrap">
                        <div class="overlay">
                            <a class="popup" href="<?php echo base_url($frameworks_dir . '/assets/images/portfolio/6.jpg'); ?>">
                                <i class="fa fa-link"></i>
                            </a>
                            <h3>Photoshop</h3>
                            <p>The majority have suffered alteration in some form</p>
                    ...
                    <div class="featured-wrap">
                        <ul>
                            <li class="wow fadeInLeft" data-wow-delay=".1s">
                                ...
                                <div class="featured-content">
                                    <div class="featured-img">
                                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/featured/1.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="featured-info">
                                        <h4>Web Design</h4>
                                        <p>Alteration in some form, by injected humour, or randomised. by injected humour, or randomised.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="wow fadeInRight" data-wow-delay=".2s">
                                ...
                                <div class="featured-content">
                                    <div class="featured-img">
                                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/featured/2.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="featured-info">
                            ...
                            <li class="wow fadeInLeft" data-wow-delay=".3s">
                                ...
                                <div class="featured-content">
                                    <div class="featured-img">
                                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/featured/3.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="featured-info">
                                        <h4>PHP </h4>
                                        <p>Alteration in some form, by injected humour, or randomised. by injected humour, or randomised.</p>
                            ...
                            <li class="wow fadeInRight" data-wow-delay=".4s">
                                ...
                                <div class="featured-content">
                                    <div class="featured-img">
                                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/featured/4.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="featured-info">
                            ...
                            <li class="wow fadeInLeft" data-wow-delay=".5s">
                                ...
                                <div class="featured-content">
                                    <div class="featured-img">
                                        <img src="<?php echo base_url($frameworks_dir . '/assets/images/featured/5.jpg'); ?>" alt="" />
                                    </div>
                                    <div class="featured-info">
                                        <h4>UX/UI Design</h4>
                                        <p>Alteration in some form, by injected humour, or randomised. by injected humour, or randomised.</p>
    ...
    <!-- video-area start -->
    <section class="video-area  parallax black-opacity wow fadeInUp"  data-speed="5" data-bg-image="<?php echo base_url($frameworks_dir . '/assets/images/bg/2.jpg'); ?>">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/team/1.jpg'); ?>" alt="" />
                        </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".2s">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/team/2.jpg'); ?>" alt="" />
                        </div>
                        <div class="team-content">
                            <div class="team-info">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".3s">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/team/3.jpg'); ?>" alt="" />
                        </div>
                        <div class="team-content">
                            <div class="team-info">
                                <h3>Robert Kyle</h3>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".4s">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/team/4.jpg'); ?>" alt="" />
                        </div>
                        <div class="team-content">
                            <div class="team-info">
                                <h3>Brayden Shar</h3>
                    ...
                    <div class="col-xs-12 wow fadeInLeft">
                        <div class="client-wrap fix">
                            ...
                            <div class="client-img pull-right">
                                <img src="<?php echo base_url($frameworks_dir . '/assets/images/client/1.jpg'); ?>" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 wow fadeInRight">
                        <div class="client-wrap fix">
                            ...
                            <div class="client-img pull-left client-img2">
                                <img src="<?php echo base_url($frameworks_dir . '/assets/images/client/2.jpg'); ?>" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 wow fadeInLeft">
                        <div class="client-wrap fix">
                            ...
                            <div class="client-img pull-right">
                                <img src="<?php echo base_url($frameworks_dir . '/assets/images/client/3.jpg'); ?>" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 wow fadeInRight">
                        <div class="client-wrap fix">
                            ...
                            <div class="client-img pull-left client-img2">
                                <img src="<?php echo base_url($frameworks_dir . '/assets/images/client/4.jpg'); ?>" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- praller-area start -->
    <section class="prallex-area black-opacity parallax ptb-180 wow fadeInUp"  data-speed="3" data-bg-image="<?php echo base_url($frameworks_dir . '/assets/images/bg/3.jpg'); ?>">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s">
                    <div class="blog-wrap">
                        <div class="blog-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/blog/1.jpg'); ?>" alt="" />
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".2s">
                    <div class="blog-wrap">
                        <div class="blog-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/blog/2.jpg'); ?>" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <ul>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col wow fadeInUp" data-wow-delay=".1s">
                    <div class="blog-wrap">
                        <div class="blog-img">
                            <img src="<?php echo base_url($frameworks_dir . '/assets/images/blog/3.jpg'); ?>" alt="" />
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <ul>
